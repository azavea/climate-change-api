...
sys.path.insert(0, os.path.abspath('../../django/climate_change_api'))
os.environ['DJANGO_SETTINGS_MODULE'] = 'climate_change_api.settings'
django.setup()
...
# pixels large.
html_favicon = '_static/css/favicon.ico'
...
htmlhelp_basename = 'AzaveaClimateDataAPIdoc'
