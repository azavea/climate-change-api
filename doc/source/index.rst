...
`Logging in`_ directs you to the Climate API User Profile page, which contains your API token. A valid token is required to make requests to the API. Should you generate a new token, your old token will expire and any instance of it must be updated to access the API.
...
Voila! You've just made your first Climate API request.
